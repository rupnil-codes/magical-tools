![Magical Tools Banner](https://cdn.modrinth.com/data/cached_images/eff65c80f283264301868b1557cf56edd4c31d62.jpeg)

---

## About
**Magical Tools** is a simple Minecraft Mod that adds magical items that help with day-to-day tasks and bumps up QoL! It is meant for a submission to one of Hackclub's event, [Hackcraft](https://hackcraft.hackclub.com/). This was the first ever mod that I created and I would be lying if I said I didnt enjoy it (though it was painful).

With the Magical Tool's mod you get access to four(4) new items with unique properties that makes playing Minecraft more fun and less tedious. These items are somewhat magical and hence the name.

>  Note: Magical Tools may have issues, bugs and silly optimisation errors, please let me know by following the issue link!

> Note: All custom assets are made by me in Aseprite!
...
<p align="center">
    <b>Made with 💖 by @rupnil.codes</b>
</p>
<p align="center">
    If you found this project interesting, consider giving it a star :D
</p>
<p align="center">
    <a href="https://github.com/rupnil-codes/magical-tools/issues">Report a Bug</a> or <a href="https://github.com/rupnil-codes/magical-tools/issues">Suggest a new Feature</a>
</p>